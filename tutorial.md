...
- 项目的最顶层目录
    ...
    ![image-20240313112605668](../../../../Documents/Tutorial_mySLAM/figure/image-20240313112605668.png)

- src中的功能包目录-这里的功能包都放在了Ground-Fusion里面，这里需要在终端中打开此文件夹，再输入clion ./

![image-20240313112722110](../../../../Documents/Tutorial_mySLAM/figure/image-20240313112722110.png)

​	对应的Top-level的CMakeLists.txt就与这些功能包在同一级别

<img src="../../../../Documents/Tutorial_mySLAM/figure/image-20240313112945684.png" alt="image-20240313112945684" style="zoom:80%;" />
...
![image-20240313115142941](../../../../Documents/Tutorial_mySLAM/figure/image-20240313115142941.png)

- build设置 | run

    运行左侧就有一个“T”字符代表着编译文件，需要先编译，然后再去运行

![2024-03-13_11-05](../../../../Documents/Tutorial_mySLAM/figure/2024-03-13_11-05-1710338228235-2.png)
