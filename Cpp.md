...
- 多级页表虽然解决了空间上的问题，但是虚拟地址到物理地址的转换就多了几道转换的工序，这显然就降低了这俩地址转换的速度，也就是带来了时间上的开销。
  ...
  - CPU 芯片中，加入了一个专门存放程序最常访问的页表项的 Cache，这个 Cache 就是 TLB，通常称为页表缓存、转址旁路缓存、快表等。
    ...
    <img src="figure/a3cdf27646b24614a64cfc5d7ccffa35.png" alt="img" style="zoom: 67%;" />
...
- 用户态与内核态是针对CPU的权限级别而言的，用户态可以通过系统调用/异常/硬件中断转换到内核态

![image-20250406004044394](figure/image-20250406004044394.png)
