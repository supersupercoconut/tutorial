...
- fastlio
  - 0.003068 0.002101 0.000803  | -0.003450 0.007814 -0.010441 
  - 0.004520 -0.001463 -0.058183 | 0.036240 -0.009045 -0.021200
...
- 相机
  - 投影模型 (RGB/全景/深度/鱼眼相机)
    - RGB相机：基于相似三角形可以计算，直接将世界系中的一个点投影到二维像素平面上，由于其投影方式是沿直线投影，所以其能观察到的视野是受限的。
